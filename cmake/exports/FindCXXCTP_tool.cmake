...
set(FindCXXCTP_tool_LIST_DIR "${CMAKE_CURRENT_LIST_DIR}"
...
if(CXXCTP_tool)
    ...
    if(NOT CXXCTP_tool_PROGRAM)
        message(WARNING "Program 'CXXCTP_tool' not found, unable to run 'CXXCTP_tool'.")
    ...
    function(target_add_CXXCTP_tool TARGET GUID INPUTS OUTDIR EXTRA_ARGS)
      ...
      add_custom_target(CXXCTP_tool_target_for_${TARGET}_${GUID} ALL
        COMMAND ${CMAKE_COMMAND}
                ...
                -P ${FindCXXCTP_tool_LIST_DIR}/run_CXXCTP_tool.cmake )
